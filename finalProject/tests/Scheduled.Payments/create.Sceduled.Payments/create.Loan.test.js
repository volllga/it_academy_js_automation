...
const category = constants.CATEGORY_LOAN;

let lastPaymentID;
let newPaymentID;


describe ('Creation a new Scheduled LOAN.',  async () => {
  before(async () => {
  ...
  it(`User cah create new LOAN with driver, category, amount and deduct by`, async () => {
    ...
    await ModalFormNewPayment.chooseRadioLoan(); // work only here!!! do not move!!!
