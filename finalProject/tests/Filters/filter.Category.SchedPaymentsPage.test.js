...
describe ('Scheduled Payments Page. Category filters tests.',  () => {
  ...
  it('User can filter Scheduled Payments by Expense Category', async () => {
    const badgeFilter = await filtersScheduledPaymentsObject.filterByCategory(constants.CATEGORY_EXPENSE);
  ...
  it('User can filter Scheduled Payments by Expense sub Category ', async () => {
    const badgeFilter = await filtersScheduledPaymentsObject.filterByCategory(constants.CATEGORY_EXPENSE_SUB);
    const badgeText = await badgeFilter.getText();
    await filtersScheduledPaymentsObject.clearAll();
  ...
  it('User can filter Scheduled Payments by Escrow Category', async () => {
    const badgeFilter = await filtersScheduledPaymentsObject.filterByCategory(constants.CATEGORY_ESCROW);
    const badgeText = await badgeFilter.getText();
    await filtersScheduledPaymentsObject.clearAll();
  ...
  it('User can filter Scheduled Payments by Loan Category', async () => {
    const badgeFilter = await filtersScheduledPaymentsObject.filterByCategory(constants.CATEGORY_LOAN);
    const badgeText = await badgeFilter.getText();
    await filtersScheduledPaymentsObject.clearAll();
  ...
  it('User can filter Scheduled Payments by Loan sub Category', async () => {
    const badgeFilter = await filtersScheduledPaymentsObject.filterByCategory(constants.CATEGORY_LOAN_SUB);
    const badgeText = await badgeFilter.getText();
    await filtersScheduledPaymentsObject.clearAll();
